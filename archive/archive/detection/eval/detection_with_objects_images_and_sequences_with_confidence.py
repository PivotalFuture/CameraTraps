...
from analyze_image_detection_using_confidence import compute_precision_recall_with_images
...
if __name__ == '__main__':
    ...
    seq_prec, seq_recall, seq_ap, seq_scores = compute_precision_recall_with_sequences(detection_file, db_file, detection_results=detection_results)
